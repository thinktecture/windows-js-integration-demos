(function () {
    ...
    function DateService() {
        this.safeGetDate = function (date, convertToLocalTime, alwaysReturnDate) {
            ...
            if (date.getMonth) {
                return date;
            } // it's quite likely already a date object
        ...
        this.safeDateFormat = function (date, format, convertToLocalTime) {
            if (date) {
        ...
        this.isoStringFromDate = function (date, convertToLocalTime) {
            if (date) {
    ...
    ttBase.module.service("dateService", [DateService]);
})();